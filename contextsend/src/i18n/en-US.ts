export default {
  ...
  receive: {
    ...
    metaTokensDetail: 'in {input} / out {output}',
    metaLatency: 'first token {value}',
    metaReasoning: 'reasoning {count} tokens',
    delete: 'Delete',
    edit: 'Edit',
    copy: 'Copy',
    more: 'More',
  ...
  settings: {
    ...
    adapters: {
      ...
      portInvalid: 'Port must be an integer between {min} and {max}',
